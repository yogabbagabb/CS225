...
class List
{
  ...
  public:
    ...
    void waterRecurse(ListNode*& head, ListNode*& tail);
...
#include "list_given.h"
  ...
  private:
    ...
    /*
      Finds length between startig node and ending node
    */
    int findLength(ListNode*& start, ListNode*& end) const;
    /**
