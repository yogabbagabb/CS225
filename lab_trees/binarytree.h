...
class BinaryTree
{
  ...
  public:
    ...
    // triple<int, int, bool> isOrderedB(Node * const subroot) const;

    bool isOrdered(Node * const subroot) const;
    ...
    void printPaths(vector<T> vec, Node *  subroot) const;
    /**
