...
int main(int argc, char** argv)
{
    ...
    for (int index = 0; index < 15; index++)
        myBST.insert(index, false);

    printTreeInfo(myBST, "Test #1",
                  "Bigger, Randomly Ordered Tree");
    ...
    for (int i = 0; i < 10; i++)
    {
      myBST.insert(ordering[9-i], true);
    }

    printTreeInfo(myBST, "Test #2", "More Random");
    ...
    for (int i = 0; i < 3; i++)
    {
      myBST.insert(ordering[2-i], true);
    }
